      ...
      008004 CC 81 A6         [ 2]   88 	jp	_main
                                     ...
                                     92 ;--------------------------------------------------------
                                     93 	.area CODE
                                     94 ;	main.c: 19: void delay_us(uint16_t us) {
                                     95 ;	-----------------------------------------
                                     96 ;	 function delay_us
                                     97 ;	-----------------------------------------
      00802E                         98 _delay_us:
                                     99 ;	main.c: 20: while(us--) {
      00802E                        100 00101$:
      ...
      008035 81               [ 4]  105 	ret
      008036                        106 00117$:
                                    107 ;	main.c: 21: __asm__("nop"); __asm__("nop"); __asm__("nop");
      008036 9D               [ 1]  108 	nop
      008037 9D               [ 1]  109 	nop
      008038 9D               [ 1]  110 	nop
                                    111 ;	main.c: 22: __asm__("nop"); __asm__("nop"); __asm__("nop");
      008039 9D               [ 1]  112 	nop
      00803A 9D               [ 1]  113 	nop
      00803B 9D               [ 1]  114 	nop
      00803C 20 F0            [ 2]  115 	jra	00101$
                                    116 ;	main.c: 24: }
      00803E 81               [ 4]  117 	ret
                                    118 ;	main.c: 26: void delay_ms(uint16_t ms) {
                                    119 ;	-----------------------------------------
      ...
      008041 1F 05            [ 2]  124 	ldw	(0x05, sp), x
                                    125 ;	main.c: 28: for (i = 0; i < ((F_CPU / 18000UL) * ms); i++)
      ...
      008063 24 0F            [ 1]  143 	jrnc	00105$
                                    144 ;	main.c: 29: __asm__("nop");
      008065 9D               [ 1]  145 	nop
                                    146 ;	main.c: 28: for (i = 0; i < ((F_CPU / 18000UL) * ms); i++)
      ...
      008076 81               [ 4]  158 	ret
                                    159 ;	main.c: 47: void tm_delay() {
                                    160 ;	-----------------------------------------
                                    161 ;	 function tm_delay
                                    162 ;	-----------------------------------------
      008077                        163 _tm_delay:
      008077 52 02            [ 2]  164 	sub	sp, #2
                                    165 ;	main.c: 48: for (volatile int i = 0; i < 50; i++) __asm__("nop");
      ...
      0080C6 6B 01            [ 1]  229 	ld	(0x01, sp), a
                                    230 ;	main.c: 72: for (uint8_t i = 0; i < 8; i++) {
      0080C8 0F 02            [ 1]  231 	clr	(0x02, sp)
      0080CA                        232 00106$:
                                    233 ;	main.c: 73: TM_CLK_PORT &= ~(1 << TM_CLK_PIN);
      0080CA C6 50 00         [ 1]  234 	ld	a, 0x5000
      0080CD A4 FB            [ 1]  235 	and	a, #0xfb
                                    236 ;	main.c: 72: for (uint8_t i = 0; i < 8; i++) {
      ...
      00813B 24 0F            [ 1]  314 	jrnc	00101$
                                    315 ;	main.c: 103: tm_write_byte(segments[i]);
      ...
      00816D 2B 28            [ 1]  356 	jrmi	00103$
                                    357 ;	main.c: 120: digits[i] = digit_to_segment[val % 10];
      ...
      0081A5 81               [ 4]  392 	ret
                                    393 ;	main.c: 131: void main() {
                                    394 ;	-----------------------------------------
                                    395 ;	 function main
                                    396 ;	-----------------------------------------
      0081A6                        397 _main:
                                    398 ;	main.c: 133: CLK_CKDIVR = 0x00; // forcer la frequence CPU
      0081A6 35 00 50 C6      [ 1]  399 	mov	0x50c6+0, #0x00
                                    400 ;	main.c: 135: PA_DDR |= (1 << TM_CLK_PIN) | (1 << TM_DIO_PIN); // CLK & DIO en sortie
      0081AA C6 50 02         [ 1]  401 	ld	a, 0x5002
      0081AD AA 06            [ 1]  402 	or	a, #0x06
      0081AF C7 50 02         [ 1]  403 	ld	0x5002, a
                                    404 ;	main.c: 136: PA_CR1 |= (1 << TM_CLK_PIN) | (1 << TM_DIO_PIN); // Push-pull
