      ...
      008115 35 54 52 00      [ 1]   57 	mov	0x5200+0, #0x54
                                     58 ;	../../lib/spi.c: 6: SPI_CR2 = (1 << SPI_CR2_SSM) | (1 << SPI_CR2_SSI) | (1 << SPI_CR2_BDM) | (1 << SPI_CR2_BDOE);
      008119 35 C3 52 01      [ 1]   59 	mov	0x5201+0, #0xc3
                                     60 ;	../../lib/spi.c: 7: }
      00811D 81               [ 4]   61 	ret
      ...
      00811E A6 FF            [ 1]   68 	ld	a, #0xff
      008120 CD 81 2C         [ 4]   69 	call	_SPI_write
                                     70 ;	../../lib/spi.c: 11: while (!(SPI_SR & (1 << SPI_SR_RXNE)));
      008123                         71 00101$:
      008123 72 01 52 03 FB   [ 2]   72 	btjf	0x5203, #0, 00101$
                                     73 ;	../../lib/spi.c: 12: return SPI_DR;
      008128 C6 52 04         [ 1]   74 	ld	a, 0x5204
                                     75 ;	../../lib/spi.c: 13: }
      00812B 81               [ 4]   76 	ret
                                     ...
                                     80 ;	-----------------------------------------
      00812C                         81 _SPI_write:
                                     82 ;	../../lib/spi.c: 16: SPI_DR = data;
      00812C C7 52 04         [ 1]   83 	ld	0x5204, a
                                     84 ;	../../lib/spi.c: 17: while (!(SPI_SR & (1 << SPI_SR_TXE)));
      00812F                         85 00101$:
      00812F 72 03 52 03 FB   [ 2]   86 	btjf	0x5203, #1, 00101$
                                     87 ;	../../lib/spi.c: 18: }
      008134 81               [ 4]   88 	ret
                                     89 	.area CODE
                                     90 	.area CONST
